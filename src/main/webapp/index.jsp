        ...
        <div class="intro-right">
            ...
            <div class="intro-block">
                ...
                <p>
                    ...
                    Đầy đủ danh mục: lều trại, túi ngủ, bàn ghế dã ngoại, dụng cụ sinh tồn, balo chống nước và phụ kiện
                    tiện ích.
            ...
            <div class="intro-block">
                ...
                <p>
                    ...
                    Mỗi sản phẩm đều được kiểm tra chất lượng trước khi lên kệ để đồng hành cùng bạn trong mọi hành
                    trình.
                </p>
            </div>
        </div>
...
<section id="product1" class="section-p1">
    ...
    <div class="pro-container">
        <c:forEach items="${latestProductsDefault}" var="p">
            <div class="pro">
        ...
        <c:if test="${empty latestProductsDefault}">
...
<script>
    ...
    const addToCartAjax = async (variantId, qty = 1) => {
        const url =
            CONTEXT_PATH +
            "/cart?action=addAjax" +
        ...
        updateMiniCartBadge(data.cartCount);
    };

    document.addEventListener("click", (e) => {
        const btn = e.target.closest("a.js-add-to-cart");
        if (!btn) return;
        ...
        addToCartAjax(variantId, 1).catch(console.error);
    });
</script>
<script>
