...
<html lang="en">
  ...
  <section id="header">
    ...
    <section id="page-header" class="about-header">
      <h2>#Thảo luận</h2>
      <p>Hãy để lại lời nhắn. Chúng tôi rất sẵn lòng!</p>
    </section>

    <section id="contact-details" class="section-p1">
        <div class="details">
            <span>Liên lạc</span>
            <h2>Ghé thăm một trong các địa điểm đại lý của chúng tôi hoặc liên hệ với chúng tôi ngay hôm nay</h2>
            <h3>Trụ sở chính</h3>
            <div>
                <li>
                    <i class="fa-solid fa-map"></i>
                    <p>56 Phường Linh Trung, Kp6, TP.Thủ Đức, HCM</p>
                </li>
                <li>
                    <i class="fa-solid fa-envelope"></i>
                    <p>campshop@gmail.com</p>
                </li>
                <li>
                ...
                <li>
                    ...
                    <p>Thứ 2 đến thứ 7: 9.00pm to 16.pm</p>
                </li>
            </div>
        </div>

        <div class="map">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3918.21452551595!2d106.78918677451831!3d10.871281657438018!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3175276398969f7b%3A0x9672b7efd0893fc4!2zVHLGsOG7nW5nIMSQ4bqhaSBo4buNYyBOw7RuZyBMw6JtIFRQLiBI4buTIENow60gTWluaA!5e0!3m2!1svi!2s!4v1761716186875!5m2!1svi!2s" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
    </section>
    ...
    <section id="form-details">
        <form action="">
            ...
            <h2>Chúng tôi rất mong nhận được phản hồi</h2>
