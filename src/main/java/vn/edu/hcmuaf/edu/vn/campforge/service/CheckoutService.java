...
public class CheckoutService {
    ...
    public static class PlaceOrderResult {
        ...
        public PlaceOrderResult(int orderId, BigDecimal total, String paymentMethod, String vnpTxnRef) {
    ...
    public PlaceOrderResult placeOrderWithMeta(
            Cart cart,
            Integer userId,
            String receiverName,
            String phone,
        ...
        if (payMethod.equalsIgnoreCase("VNPAY")) {
            vnpTxnRef = VnpayConfig.getRandomNumber(12);
        }
        ...
        try (Connection conn = DbConnect.getConnection()) {
            ...
            try {
                ...
                shippingDAO.insert(conn, orderId, receiverName, phone, email, addressLine, ward, district, province, note);
        ...
        return new PlaceOrderResult(orderId, total, payMethod, vnpTxnRef);
    }
